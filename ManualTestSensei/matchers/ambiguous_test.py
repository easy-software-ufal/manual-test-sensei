...
def find(test: Test): # TODO: Muito código repetido. Refazer
    """
    ...
    for step in test.steps:
        ...
        for match_id, start, end in action_matches:
            ...
            helpers._store_smell(step, smells_names.AMBIGUOUS_TEST, 'comparative adverb', 'action', span)
    ...
    for step in test.steps:
        for reaction in step.reactions:
            ...
            for match_id, start, end in reaction_matches:
                ...
                helpers._store_smell(step, smells_names.AMBIGUOUS_TEST, 'comparative adverb', 'verification', span)
    ...
    for step in test.steps:
        ...
        for match_id, start, end in action_matches:
            ...
            helpers._store_smell(step, smells_names.AMBIGUOUS_TEST, 'adverb of manner', 'action', span)
